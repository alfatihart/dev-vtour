        ...
        <div class="page-header-content">
            <div class="row align-items-center justify-content-between pt-3">
                ...
                <div class="col-12 col-xl-auto mb-3">
                    <a class="btn btn-sm btn-light text-primary" href="/scenes/create">
                ...
                <tbody>
                    ...
                    foreach ($scenes as $scene) : ?>
                        <tr>
                            ...
                            <td><?= $scene['yaw']; ?></td>
                            <td>
                                <img src="/scenes/thumbnail?image=<?= $scene['image']; ?>" width="100px" class="img-fluid" alt="Panorama Image">
                            </td>
                            <td>
                                <div class="gap-3">
                                    <a href="/scenes/<?= $scene['slug']; ?>" class="btn btn-sm btn-primary">
                                        <i class="fa fa-eye me-1"></i>Show</a>
                                    <a href="/scenes/edit/<?= $scene['slug']; ?>" class="btn btn-sm btn-warning">
                                        <i class="fa fa-edit me-1"></i>Edit</a>
                                    <!-- Button trigger modal -->
                                    <form id="deleteForm#<?= $scene['id']; ?>" action="/scenes/<?= $scene['id']; ?>" method="post" class="d-inline">
                                        <?= csrf_field(); ?>
