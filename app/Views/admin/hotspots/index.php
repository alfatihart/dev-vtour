        ...
        <div class="page-header-content">
            <div class="row align-items-center justify-content-between pt-3">
                ...
                <div class="col-12 col-xl-auto mb-3">
                    <a class="btn btn-sm btn-light text-primary" href="/hotspots/create">
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <a href="/hotspots/edit/<?= $hotspot['id']; ?>" class="btn btn-sm btn-warning" role="button">
                                        <i class="fa fa-edit me-1"></i>Edit</a>
                                    <!-- Button trigger modal -->
                                    <form id="deleteForm#<?= $hotspot['id']; ?>" action="/hotspots/<?= $hotspot['id']; ?>" method="post" class="d-inline">
                                        <?= csrf_field(); ?>
