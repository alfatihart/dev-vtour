...
<div class="container-xl px-4 mt-4">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="/hotspots/update/<?= $hotspot['id']; ?>" method="post" class="row g-3">
                <?= csrf_field(); ?>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <img id="previewImage" class="img-thumbnail img-fluid" src="/assets/img/no-image.png" alt="Preview">
                    </div>
