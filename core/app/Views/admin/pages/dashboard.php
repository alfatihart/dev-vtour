            ...
            <a class="card lift h-100" href="./scenes">
                <div class="card-body d-flex justify-content-center flex-column">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <img src="assets/img/illustrations/browser-stats.svg" alt="Scenes" style="width: 8rem" />
                    </div>
                </div>
            </a>
        </div>
            ...
            <a class="card lift h-100" href="./hotspots">
                <div class="card-body d-flex justify-content-center flex-column">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <img src="assets/img/illustrations/processing.svg" alt="Hotspots" style="width: 8rem" />
                    </div>
                </div>
            </a>
        </div>
            ...
            <a class="card lift h-100" href="./maps">
                <div class="card-body d-flex justify-content-center flex-column">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <img src="assets/img/illustrations/windows.svg" alt="Maps" style="width: 8rem" />
                    </div>
                </div>
            </a>
        </div>
